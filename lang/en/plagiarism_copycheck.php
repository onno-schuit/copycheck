...
$string['webservice_url']				= 'Webservice url';
$string['webservice_url_help']			= 'This is the url of the webservice of the CopyCheck Plagiarism Plugin, default http://www.copycheck.eu/CCservices.asmx.';
$string['reporturl']					= 'Report url';
$string['reporturl_help']				= 'This is the url to which the webservice of the CopyCheck Plagiarism Plugin responds.';
